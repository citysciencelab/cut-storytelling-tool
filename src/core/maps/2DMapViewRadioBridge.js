...
channel.reply({
    ...
    "getOptions": function () {
        return findWhereJs(mapCollection.getMapView("ol", "2D").options_, {resolution: mapCollection.getMapView("ol", "2D").getConstrainedResolution(mapCollection.getMapView("ol", "2D").getResolution())});
    },
    "getCenter": function () {
