...
- Issue #778: Fixed layer information display selection in metadata window. Now the select is only offered if at least two dislayable options exist, and a displayable is pre-selected.
