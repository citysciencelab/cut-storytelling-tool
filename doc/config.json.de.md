...
|format|nein|String[]|[ ]|Welches Format default ausgewählt ist. Aktuell möglich sind "GEOJSON", "KML" und "GPX".|false|
...
|type|ja|String||Welche Typ für die Geosuche verwendet werden soll. Aktuell möglich sind "BKG" und "NOMINATIM".|false|
...
|limit|nein|Number|1000|Die maximale Anzahl an Zeilen in einer CSV die verarbeitet werden soll/darf.|false|
|maximumConcurrentRequests|nein|Number|3|Die maximale Anzahl an Aufrufen die an externe Services parallel gemacht werden dürfen. Zu viele schränken die parallele Arbeit mit der Karte ein. Zu wenig verlangsamt die Stapelverarbeitung. Maximal können in Browser 6 Requests gleichzeitig gemacht werden.|false|
...
|serviceId|ja|String||Welcher Service für die Abfrage verwendet werden soll.|false|
|speedProfile|nein|String|"CAR"|Welches Geschwindigkeitsprofile verwendet werden soll.|false|
|isochronesMethodOption|nein|String|"TIME"|Welches Methode für den Abruf verwendet werden soll.|false|
