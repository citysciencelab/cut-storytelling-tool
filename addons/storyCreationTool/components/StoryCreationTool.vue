        ...
        close() {
            const closeStoryCreationTool = () => {
                ...
                const model = Radio.request(
                    ...
                    {
                        id: this.$store.state.Tools.StoryCreationTool.id
                    }
                );
            ...
            const isCreatingAStory =
                ...
                JSON.stringify(
                    this.$store.state.Tools.StoryCreationTool.storyConf
                ) !== JSON.stringify(this.constants.emptyStoryConf);

            if (isCreatingAStory) {
                const confirmActionSettings = {
                    actionConfirmedCallback: closeStoryCreationTool,
