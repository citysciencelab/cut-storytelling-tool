...
<template lang="html">
    <div
        ...
        id="tool-storyCreationTool-player"
    >
        <div id="tool-storyCreationTool-currentStep">
            <!--<h3>{{ storyConf.name }}</h3>-->
            <p> </p>
            <h2 v-if="currentChapter">{{ currentChapter.chapterTitle }}</h2>
            <h1>{{ currentStep.title }}</h1>

            <div v-if="currentStep" class="tool-storyCreationTool-content">
    ...
    <div v-else id="tool-storyCreationTool-tableOfContents">
        <h1>{{ storyConf.name }}</h1>

        <h2>
            {{
                $t("additional:modules.tools.storyCreationTool.tableOfContents")
            }}
        </h2>
...
#tool-storyCreationTool-currentStep,
#tool-storyCreationTool-tableOfContents {
    display: grid;
    grid-gap: 10px;
    overflow: hidden;
}

.tool-storyCreationTool-content {
    overflow: auto;
