    ...
    data() {
        return {
            ...
            step: this.initialStep || {
                stepNumber: 1,
                stepWidth: this.$store.state.Tools.StoryCreationTool
                    .initialWidth,
                visible: true,
            ...
            newChapter: {
                chapterNumber:
                    this.$store.state.Tools.StoryCreationTool.storyConf.chapters
                        .length + 1,
                chapterTitle: ""
            },
            htmlContent:
                (this.initialStep &&
                    this.$store.state.Tools.StoryCreationTool.htmlContents[
                        getHTMLContentReference(
            ...
            htmlContentImages:
                (this.initialStep &&
                    this.$store.state.Tools.StoryCreationTool.htmlContentsImages[
                        getHTMLContentReference(
                            this.initialStep.associatedChapter,
                            this.initialStep.stepNumber
                        )
    ...
    computed: {
        ...
        chapterOptions() {
            ...
            const newChapterOption = {
                value: null,
                text: this.$t(
                    "additional:modules.tools.storyCreationTool.newChapter"
                )
            };
    ...
    methods: {
        ...
        onChangeChapterNumber(event) {
            ...
            if (
                ...
                event.target.setCustomValidity(
                    this.$t(
                        "additional:modules.tools.storyCreationTool.error.chapterNumberAlreadyExists"
                    )
                );
            } else {
                event.target.setCustomValidity("");
        ...
        onChangeStepNumber(event) {
            ...
            if (
                ...
                event.target.setCustomValidity(
                    this.$t(
                        "additional:modules.tools.storyCreationTool.error.stepNumberAlreadyExists"
                    )
                );
            } else {
                event.target.setCustomValidity("");
        ...
        async onAddImage(imageFile, Editor, cursorLocation, resetUploader) {
            try {
                ...
                Radio.trigger("Alert", "alert", {
                    text: i18next.t(
                        "additional:modules.tools.storyCreationTool.error.errorAddingImage"
                    ),
                    category: "Error",
        ...
        onDeleteStep() {
            ...
            const confirmActionSettings = {
                ...
                confirmCaption: this.$t(
                    "additional:modules.tools.storyCreationTool.confirm.deleteStep.confirmButton"
                ),
                denyCaption: this.$t(
                    "additional:modules.tools.storyCreationTool.confirm.deleteStep.denyButton"
                ),
                textContent: this.$t(
                    "additional:modules.tools.storyCreationTool.confirm.deleteStep.description"
                ),
                headline: this.$t(
                    "additional:modules.tools.storyCreationTool.confirm.deleteStep.title"
                ),
...
<template lang="html">
    <div id="tool-storyCreationTool-creator-stepForm">
        <h4>
            {{
                $t("additional:modules.tools.storyCreationTool.createStoryStep")
            }}
        </h4>
        ...
        <form @submit.prevent="onSubmit">
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.chapter"
                        )
                    }}
                </label>
            ...
            <div v-if="step.associatedChapter === null" class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.newChapterNumber"
                        )
                    }}
                </label>
            ...
            <div v-if="step.associatedChapter === null" class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.newChapterTitle"
                        )
                    }}
                </label>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.stepNumber"
                        )
                    }}
                </label>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.stepTitle"
                        )
                    }}
                </label>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.stepWidth"
                        )
                    }}
                </label>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.visible"
                        )
                    }}
                </label>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.centerCoordinate"
                        )
                    }}
                </label>
                ...
                >
                    <small>
                        {{
                            $t(
                                "additional:modules.tools.storyCreationTool.warning.mapMoved"
                            )
                        }}
                    </small>
                </p>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.zoomLevel"
                        )
                    }}
                </label>
                ...
                >
                    <small>
                        {{
                            $t(
                                "additional:modules.tools.storyCreationTool.warning.mapZoomed"
                            )
                        }}
                    </small>
                </p>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.layers"
                        )
                    }}
                </label>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.interactionAddons"
                        )
                    }}
                </label>
            ...
            <div class="form-group">
                <label class="form-label">
                    {{
                        $t(
                            "additional:modules.tools.storyCreationTool.label.htmlContent"
                        )
                    }}
                </label>
            ...
            >
                {{
                    $t(
                        "additional:modules.tools.storyCreationTool.button.cancel"
                    )
                }}
            </button>
            <button
            ...
            >
                {{
                    $t(
                        "additional:modules.tools.storyCreationTool.button.deleteStep"
                    )
                }}
            </button>
            <button type="submit" class="btn btn-lgv-grey">
                {{
                    $t(
                        isEditing
                            ? "additional:modules.tools.storyCreationTool.button.submitEditStep"
                            : "additional:modules.tools.storyCreationTool.button.submitAddStep"
                    )
                }}
            </button>
        </form>
...
#tool-storyCreationTool-creator-stepForm {
    max-width: 460px;
