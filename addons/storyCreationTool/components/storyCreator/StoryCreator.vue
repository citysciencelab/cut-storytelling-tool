...
<template lang="html">
    <div id="tool-storyCreationTool-creator">
        <StoryForm
        ...
        <div
            ...
            class="tool-storyCreationTool-creator-preview"
        >
            <div class="tool-storyCreationTool-creator-preview-header primary">
...
.tool-storyCreationTool-creator-preview {
    display: grid;
